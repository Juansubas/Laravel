            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('posts.store') }}">
                        ...
                        Title:
                        <br />
                        <input type="text" name = "title" class="block font-medium text-sm text-cyan-950 dark:text-red-400"/>
                        <br />
                        Post text:
                        <br />
                        <textarea name="post_text" class="block font-medium text-sm text-cyan-950 dark:text-red-400"></textarea>
                        <br />
                        Category:
                        <br />
